 ...
 * @author LAPTOP
 */
public class EditProductControllers extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      String categoryId =request.getParameter("ecategory");
      String id = request.getParameter("eid");
      int quantity =Integer.parseInt(request.getParameter("quantity"));
      DAO dao = new DAO();
      dao.updateProduct(id, name, image, price, title, description, categoryId, quantity);
