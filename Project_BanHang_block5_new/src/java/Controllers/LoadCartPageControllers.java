 ...
 * @author LAPTOP
 */
public class LoadCartPageControllers extends HttpServlet {
...
// tach mang + xac nhan product do co phai cua user hienj tai ko
                ...
                for (int i = 0; i < cookiesLength/3; i++) {
                 ...
                 Item  item = new Item(acc.getUser(), values[itemidPosition],
                            Integer.parseInt(values[pidPosition]), 
                         Integer.parseInt(values[quantityPosition])
